            ...
            <div class="bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg border border-gray-800">
                <div class="p-8">
                    ...
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <h2 class="text-xl font-bold text-white tracking-tight">Add Category</h2>
                    </div>
                    ...
                    <form action="{{ route('category.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-800">
                            <a href="{{ route('category.index') }}" class="px-5 py-2 text-sm font-medium text-gray-400 hover:text-white transition">
                                Cancel
                            </a>
                            <button type="submit" class="px-6 py-2 bg-white text-gray-900 text-sm font-bold rounded-lg hover:bg-gray-200 transition active:scale-95 shadow-lg">
                                Save Category
                            </button>
                        </div>
                    </form>
